  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-background">
      <header className="border-b border-black/10 bg-surface dark:border-white/10">
        ...
        {/* Nav horizontal — solo en escritorio, en celular se usa BottomNav */}
        <nav className="mx-auto hidden max-w-5xl gap-1 px-6 lg:flex">
          <Link
            href="/portal"
      ...
      <main className="mx-auto max-w-5xl px-6 py-10 pb-24 lg:pb-10">{children}</main>
